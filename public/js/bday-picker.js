  ...
  $.fn.birthdaypicker = function( options ) {
    ...
    return this.each(function() {
      ...
      var $fieldset = $("<fieldset class='birthdayPicker'></fieldset>"),
          $year = $("<select class='birthYear' name='birth[year]'></select>"),
          $month = $("<select class='birthMonth' name='birth[month]'></select>"),
          $day = $("<select class='birthDate' name='birth[day]'></select>");
      ...
      $fieldset.change(function() {
        ...
        if ((selectedYear * selectedMonth * selectedDay) != 0) {
          ...
          $(this).find('#birthdate').val(hiddenDate);
