    ...
    generateBirthdayPicker = function ($parent, options) 
    {
        ...
        // Create the html picker skeleton
          var $fieldset = $("<fieldset class='birthdayPicker'></fieldset>"),
            $year = $("<select class='birthYear' id='birthYear' name='"+parentId+"_birth[year]'></select>"),
              $month = $("<select class='birthMonth' id='birthMonth' name='"+parentId+"_birth[month]'></select>"),
              $day = $("<select class='birthDate' id='birthDate' name='"+parentId+"_birth[day]'></select>")
